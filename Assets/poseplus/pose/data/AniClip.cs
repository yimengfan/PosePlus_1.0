...
namespace FB.PosePlus
{
    ...
    public class AniClip : ScriptableObject, IPlayAni
    {
        ...
        //    byte[] RemoveListener = BitConverter.GetBytes((ushort)frames.Count);//framecount
        //    stream.Write(RemoveListener, 0, 2);
        //    ushort bcount = (ushort)frames[0].bonesinfo.Length;
        //    RemoveListener = BitConverter.GetBytes(bcount);//bonecount
        //    stream.Write(RemoveListener, 0, 2);
        //    for (int i = 0; i < frames.Count; i++)
        //    {
        ...
        //    fps = head[2];
        //    loop = head[3] == 1;
        //    byte[] RemoveListener = new byte[2];
        //    stream.Read(RemoveListener, 0, 2);
        //    ushort framecount = BitConverter.ToUInt16(RemoveListener, 0);
        //    stream.Read(RemoveListener, 0, 2);
        //    ushort bonecount = BitConverter.ToUInt16(RemoveListener, 0);
